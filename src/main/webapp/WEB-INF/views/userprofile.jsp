...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="HTML5, template, bootstrap, css, jQuery, responsive, html">
        <meta name="application-name" content="Resume html5 template">
        <meta name="description" content="Resume - Responsive HTML5 Template design & developed by www.sharojit.com from the house of www.themesplugin.com">
	   ...
	   <script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/js/bootstrap.min.js"></script>
        <!-- Google Web Fonts -->
        <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,600|Work+Sans:300" rel="stylesheet">
...
.stp-social .social:hover a,
.stp-social .social:focus a,
.stp-social .social:active a{
    background: #3498db;
    color: #fff;
}
...
ul.stp-filtered li.stp-filter:hover,
...
#stp-projects .stp-project:hover .stp-project-detals img,
#stp-projects .stp-project:focus .stp-project-detals img,
...
.stp-working:hover .stp-working-title::after,
.stp-working:focus .stp-working-title::after,
...
.stp-post:active .spt-overlay,
.stp-post:focus .spt-overlay,
.stp-post:hover .spt-overlay{
...
#stp-contact-form .stp-field input:focus ~ label,
#stp-contact-form .stp-field textarea:focus ~ label {
    top: 0px;
    font-size: 12px;
    color: #3498db;
    opacity: 1;
...
#stp-contact-form .stp-field input:focus,
#stp-contact-form .stp-field textarea:focus{
    border-color: #3498db;
}
#stp-contact-form .stp-field input{
    height: 45px;
...
@media only screen and (max-width: 350px) {
	...
	<script>UPLOADCARE_PUBLIC_KEY = 'f78da83ce6beb3f386b7';
